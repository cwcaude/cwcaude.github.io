...
After downloading and saving the file, another encrypted block is grabbed and decrypted. This time it's a WinExec() argument to register the DLL via *regsvr32.exe*.
### DLL Register Command
``` regsvr32.exe -s *generatedFilename*``` \
## Start DLL
### Code Offset: `0x00585188`
Next a *system()* call is crafted to execute this newly registered DLL.
### System Call Command
